...
.data:000000000201F530  db 24h                  ; 偏移量低字节
...
| 变量名 | IDA字节 | 计算 | 偏移 |
|--------|---------|------|------|
| m_iPawnArmor | `24h, 09h` | `(0x09<<8)\|0x24` | 0x0924 |
| m_angEyeAngles | `50h, 33h` | `(0x33<<8)\|0x50` | 0x3350 |

> 上表与当前仓库的 `external-cheat-base/generated/client_dll.hpp`
> 对应。游戏更新后偏移可能改变，实现中应始终使用重新生成并经校验的符号，
> 不要将本教学示例作为永久常量复制到代码中。
